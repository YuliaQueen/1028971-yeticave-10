...
//выведение инфо о каждом лоте на странице
                    ...
                    <div class="lot-item__state">
                        ...
                        <?php
                            if ($finishing_status == 0) {
                                ...
                                $min_bid = change_number($lot_info['lot_bet_step'] +
                                        get_last_bid($link, $lot_id, $lot_info['lot_start_price'])) . ' &#8381;';
                            }
                        ...
                        <div class="lot-item__cost-state">
                            <div class="lot-item__rate">
                                ...
                                <span class="lot-item__cost"><?= change_number(get_last_bid($link, $lot_id, $lot_info['lot_start_price'])).' &#8381;';?></span>
                            </div>
                        ...
                        <form class="lot-item__form" action="https://echo.htmlacademy.ru" method="post" autocomplete="off">
                            ...
                            <button <?php if($finishing_status == 0) print('disabled'); ?> type="submit" class="button">Сделать ставку</button>
                        </form>
                    </div>
                    <div class="history">
