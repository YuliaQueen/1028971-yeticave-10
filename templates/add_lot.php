...
<form class="form form--add-lot container <?= count($errors) ? ' form--invalid': ''; ?> >" action="add.php" enctype="multipart/form-data" method="post" name="add_lot"> <!-- form--invalid -->
        ...
        <div class="form__item <?= isset($errors['lot_description']) ? 'form__item--invalid': '' ?> form__item--wide">
            ...
            <textarea id="message" name="lot_description" placeholder="Напишите описание лота"><?= trim(getPostVal('lot_description'));?></textarea>
        ...
        <div class="form__container-three">
            <div class="form__item form__item--small <?= isset($errors['lot_start_price']) ? 'form__item--invalid': '' ?>">
                ...
                <input id="lot-rate" type="text" name="lot_start_price" placeholder="0" value="<?=getPostVal('lot_start_price'); ?>">
            ...
            <div class="form__item form__item--small <?= isset($errors['lot_bet_step']) ? 'form__item--invalid': '' ?>">
                ...
                <input id="lot-step" type="text" name="lot_bet_step" placeholder="0" value="<?=getPostVal('lot_bet_step'); ?>">
            ...
            <div class="form__item <?= isset($errors['lot_end_date']) ? ' form__item--invalid': '' ?>">
                ...
                <input value="<?=getPostVal('lot_end_date'); ?>" class="form__input-date" id="lot-date" type="date" name="lot_end_date" placeholder="Введите дату в формате ГГГГ-ММ-ДД">
