...
INSERT INTO users
(user_registration_date, user_email, user_name, user_password, user_contacts)
VALUES (NOW(), 'youlka@gmail.com', 'Yulia Queen', 'qween', 'ул. Советская, 17-8'),
       (NOW(), 'ya@gmail.com', 'Ya-ya', 'qwerty', 'ул. Некрасова, 12-9'),
       (NOW(), 'gelly@yandex.ru', 'Gelick', 'qqqqqqqq', 'ул. Гайдара, 20-16');

INSERT INTO lots
(lot_name, lot_category, lot_start_price, lot_picture, lot_creation_date, lot_end_date, lot_author, lot_bet_step)
VALUES ('2014 Rossignol District Snowboard', 1, 10999, 'img/lot-1.jpg', '2019-08-20', '2019-08-28', 1, 500),
...
INSERT INTO bids
    (bid_date, bid_user, bid_amount, bid_lot)
VALUES ('2019-08-20', 1, 9000, 3),
       ('2019-08-22', 1, 12000, 4);
...
SELECT lot_name, lot_start_price, lot_picture, bids.bid_amount, lot_category
FROM lots
         JOIN bids
